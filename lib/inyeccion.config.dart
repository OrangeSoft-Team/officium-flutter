...
import 'aplicacion/autentificacion/iniciar_sesion/iniciar_sesion_bloc.dart'
    as _i8;
import 'aplicacion/autentificacion/registro/registro_bloc.dart' as _i11;
...
import 'infraestructura/oferta_laboral/fuentes/i_oferta_laboral_fuente.dart'
    as _i6;
import 'infraestructura/oferta_laboral/fuentes/modulo_repo_htttp.dart' as _i15;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i9.OfertaLaboralRepositorio>(() =>
      _i9.OfertaLaboralRepositorio(
          fuenteDeDatos: get<_i6.IOfertaLaboralFuente>()));
  gh.factory<_i10.PostularOfertaLaboralBloc>(
      () => _i10.PostularOfertaLaboralBloc(get<dynamic>()));
  gh.factory<_i11.RegistroBloc>(
      () => _i11.RegistroBloc(get<_i4.IAutentificacionFachada>()));
  gh.factory<_i12.VerDetalleOfertaLaboralBloc>(
      () => _i12.VerDetalleOfertaLaboralBloc(get<dynamic>()));
  gh.factory<_i13.VerOfertasLaboralesBloc>(
      () => _i13.VerOfertasLaboralesBloc(get<dynamic>()));
  gh.factory<_i14.EstadoAutentificacionBloc>(
      () => _i14.EstadoAutentificacionBloc(get<_i4.IAutentificacionFachada>()));
  return get;
}

class _$HttpModuloInjectable extends _i15.HttpModuloInjectable {}
