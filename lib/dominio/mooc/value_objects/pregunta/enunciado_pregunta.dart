...
class EnunciadoPregunta extends ValueObject<String> {
  @override
  final Either<ValorErroneo<String>, String> value;
  static const maxLength = 264;
  static const minLength = 16;

  factory EnunciadoPregunta(String input) {
    return EnunciadoPregunta._(
        validadorLongitudInvalida(input, maxLength, minLength)
            .flatMap(validadorStringNoVacio));
  }

  const EnunciadoPregunta._(this.value);
}
