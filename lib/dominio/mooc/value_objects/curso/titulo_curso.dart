...
class TituloCurso extends ValueObject<String> {
  @override
  final Either<ValorErroneo<String>, String> value;
  static const maxLength = 80;
  static const minLength = 4;

  factory TituloCurso(String input) {
    return TituloCurso._(validadorLongitudInvalida(input, maxLength, minLength)
        .flatMap(validadorStringNoVacio));
  }

  const TituloCurso._(this.value);
}
