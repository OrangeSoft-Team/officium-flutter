...
class NombreCiudad extends ValueObject<String> {
  @override
  final Either<ValorErroneo<String>, String> value;
  static const maxLength = 128;
  static const minLength = 2;

  factory NombreCiudad(String value) {
    return NombreCiudad._(validadorLongitudInvalida(value, maxLength, minLength)
        .flatMap(validadorStringNoVacio));
  }

  const NombreCiudad._(this.value);
}
