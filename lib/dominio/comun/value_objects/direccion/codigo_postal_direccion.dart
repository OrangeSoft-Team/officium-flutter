...
class CodigoPostalDireccion extends ValueObject<String> {
  @override
  final Either<ValorErroneo<String>, String> value;
  static const maxLength = 10;
  static const minLength = 1;

  factory CodigoPostalDireccion(String value) {
    return CodigoPostalDireccion._(
        validadorLongitudInvalida(value, maxLength, minLength)
            .flatMap(validadorStringNoVacio));
  }

  const CodigoPostalDireccion._(this.value);
}
