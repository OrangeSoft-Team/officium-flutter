...
class NombrePais extends ValueObject<String> {
  @override
  final Either<ValorErroneo<String>, String> value;
  static const maxLength = 128;
  static const minLength = 2;

  factory NombrePais(String value) {
    return NombrePais._(validadorLongitudInvalida(value, maxLength, minLength)
        .flatMap(validadorStringNoVacio));
  }

  const NombrePais._(this.value);
}
