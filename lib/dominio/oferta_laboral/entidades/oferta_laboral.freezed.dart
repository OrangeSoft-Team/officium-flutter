...
/// @nodoc
class _$OfertaLaboralTearOff {
  const _$OfertaLaboralTearOff();
...
/// @nodoc
const $OfertaLaboral = _$OfertaLaboralTearOff();
...
/// @nodoc
abstract class $OfertaLaboralCopyWith<$Res> {
  factory $OfertaLaboralCopyWith(
          OfertaLaboral value, $Res Function(OfertaLaboral) then) =
      _$OfertaLaboralCopyWithImpl<$Res>;
  $Res call(
      {Identificador uuid,
...
/// @nodoc
class _$OfertaLaboralCopyWithImpl<$Res>
    implements $OfertaLaboralCopyWith<$Res> {
  _$OfertaLaboralCopyWithImpl(this._value, this._then);

  final OfertaLaboral _value;
  // ignore: unused_field
  final $Res Function(OfertaLaboral) _then;
...
/// @nodoc
abstract class _$OfertaLaboralCopyWith<$Res>
    implements $OfertaLaboralCopyWith<$Res> {
  factory _$OfertaLaboralCopyWith(
          _OfertaLaboral value, $Res Function(_OfertaLaboral) then) =
      __$OfertaLaboralCopyWithImpl<$Res>;
  @override
  $Res call(
      {Identificador uuid,
      TituloOfertaLaboral titulo,
...
/// @nodoc
class __$OfertaLaboralCopyWithImpl<$Res>
    extends _$OfertaLaboralCopyWithImpl<$Res>
    implements _$OfertaLaboralCopyWith<$Res> {
  __$OfertaLaboralCopyWithImpl(
      _OfertaLaboral _value, $Res Function(_OfertaLaboral) _then)
      : super(_value, (v) => _then(v as _OfertaLaboral));

  @override
  _OfertaLaboral get _value => super._value as _OfertaLaboral;
