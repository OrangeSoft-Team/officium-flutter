...
import 'package:google_sign_in_platform_interface/src/types.dart' as _i15;
...
class MockFirebaseAuth extends _i1.Mock implements _i7.FirebaseAuth {
  ...
  _i4.Future<void> setSettings(
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> setPersistence(_i12.Persistence? persistence) =>
  ...
  @override
  _i4.Future<_i7.UserCredential> signInWithPopup(_i14.AuthProvider? provider) =>
      (super.noSuchMethod(Invocation.method(#signInWithPopup, [provider]),
              returnValue:
                  Future<_i7.UserCredential>.value(_FakeUserCredential()))
          as _i4.Future<_i7.UserCredential>);
  @override
  _i4.Future<void> signInWithRedirect(_i14.AuthProvider? provider) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthCredential extends _i1.Mock implements _i13.AuthCredential {
  MockAuthCredential() {
    _i1.throwOnMissingStub(this);
  }
